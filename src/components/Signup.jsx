    ...
    <div className="flex max-w-[1080px] pb-8 mx-auto items-center flex-col">
      ...
      <div className="flex flex-row rounded-t-lg w-72 mt-4">
        <Link to="/login" className="flex-1">
          <h1 className="text-xl text-center px-4 py-2 text-[#00954C] rounded-tl-lg font-bold transition-all duration-300 bg-stone-200 hover:bg-[#7BD650] hover:text-white">
            Log In
          </h1>
        </Link>
        <div className="flex-1 cursor-default">
          <h1 className="text-xl text-center px-4 py-2 flex-1 text-white bg-[#00954C] font-bold rounded-tr-lg">
            Sign Up
          </h1>
        </div>
      </div>
